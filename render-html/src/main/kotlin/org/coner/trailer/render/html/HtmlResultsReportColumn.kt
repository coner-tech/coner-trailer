...
abstract class HtmlResultsReportColumn : EventResultsReportColumnRenderer<
        TR.(ResultsType) -> Unit,
    ...
    class Position : HtmlResultsReportColumn() {
    ...
    class Signage : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            """
            @media screen and (max-width: ${MediaSize.MOBILE_MAX}px) {
    ...
    class MobilePositionSignage : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            """
    ...
    class SignageClass : HtmlResultsReportColumn() {
        override val header: TR.(ResultsType) -> Unit = {
            th {
    ...
    class SignageNumber : HtmlResultsReportColumn() {
        override val header: TR.(ResultsType) -> Unit = {
            th {
    ...
    class Name : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            """
            @media screen and (max-width: ${MediaSize.MOBILE_MAX}px) {
                th.name, td.name {
    ...
    class CarModel : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            """
            @media screen and (max-width: ${MediaSize.MOBILE_MAX}px) {
    ...
    class MobileNameCarModel : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            """
    ...
    class Score : HtmlResultsReportColumn() {
    ...
    class DiffFirst : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            CommonStyles.time,
    ...
    class DiffPrevious : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            CommonStyles.time,
            CommonStyles.hideDiffOnMobile
        )
    ...
    class Runs : HtmlResultsReportColumn() {
        override fun buildStyles(event: Event, report: ResultsReport) = setOf(
            CommonStyles.time,
            """
