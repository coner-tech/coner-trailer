...
class CrispyFishStagingLogRepository {
    ...
    fun getDistinctRuns(eventControlFile: EventControlFile, eventDay: EventDay): List<StagingRun> {
        // TODO: most of these implementation details belong in crispy fish
        // most of this is copy-paste from crispy fish internal classes, refactor and cleanup within crispy fish
