...
object TestClazzEventResults {
    ...
    object Lscc2019Simplified {
        val points1: ClassEventResults = ClassEventResults(
            eventContext = TestEventContexts.Lscc2019Simplified.points1,
            groupParticipantResults = sortedMapOf(
