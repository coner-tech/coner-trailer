...
class HelloResourcesTest {
    ...
    inner class Get {
        ...
        @Test
        fun `It should get hello world`() = testCompetitionWebapp { client ->
        ...
        @Test
        fun `It should get hello world with query param to subject`() = testCompetitionWebapp { client ->
            val actual = client.get(url) {
        ...
        @Test
        fun `It should fail with bad request when query param excessive`() = testCompetitionWebapp { client ->
            val actual = client.get(url) {
        ...
        @Test
        fun `It should be not found when exploratory disabled`() = testCompetitionWebapp(exploratory = false) { client ->
            val actual = client.get(url)
    ...
    inner class PostJson {
        ...
        @Test
        fun `It should post json with hello world body to subject`() = testCompetitionWebapp { client ->
        ...
        @Test
        fun `It should fail with bad request when post json with empty body`() = testCompetitionWebapp { client ->
            val actual = client.post(url) {
                contentType(Json)
            }
        ...
        @Test
        fun `It should fail with bad request when post json with nonsense body`() = testCompetitionWebapp { client ->
            val actual = client.post(url) {
                contentType(Json)
        ...
        @Test
        fun `It should fail with bad request when post json with excessive subject`() = testCompetitionWebapp { client ->
            val actual = client.post(url) {
                contentType(Json)
    ...
    inner class PostForm {
        ...
        @Test
        fun `It should post json with hello world form to subject`() = testCompetitionWebapp { client ->
        ...
        @Test
        fun `It should fail with bad request when post empty form`() = testCompetitionWebapp { client ->
        ...
        @Test
        fun `It should fail with bad request when post form with excessive subject`() = testCompetitionWebapp { client ->
